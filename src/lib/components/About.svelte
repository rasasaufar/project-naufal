	...
	<div class="mx-auto flex max-w-screen-2xl flex-col items-center gap-24 lg:flex-row">
		...
		<div class="order-2 flex flex-col justify-center lg:order-1 lg:w-1/2">
			...
			<div class="flex max-w-lg flex-col gap-8">
				...
				<p class="font-body text-sm leading-relaxed text-neutral-500">
					Rejecting static minimalism, I inject kineticism into every frame. Whether it’s a
					breathless TikTok cut, an expansive typography poster, or immersive brand identity, my
